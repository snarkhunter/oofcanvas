...
#define SWIGTYPE_p_Canvas swig_types[0]
...
/*-----------------------------------------------
              @(target):= _oofcanvas.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__oofcanvas

#else
#  define SWIG_init    init_oofcanvas

#endif
#define SWIG_name    "_oofcanvas"
...
SWIGINTERN PyObject *_wrap_new_Canvas(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:new_Canvas",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "new_Canvas" "', argument " "3"" of type '" "double""'");
  } 
  arg3 = static_cast< double >(val3);
  ecode4 = SWIG_AsVal_double(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "new_Canvas" "', argument " "4"" of type '" "double""'");
  } 
  arg4 = static_cast< double >(val4);
  result = (Canvas *)new Canvas(arg1,arg2,arg3,arg4);
...
SWIGINTERN PyObject *_wrap_Canvas_widget(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Canvas_widget",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Canvas, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Canvas_widget" "', argument " "1"" of type '" "Canvas *""'"); 
  }
  arg1 = reinterpret_cast< Canvas * >(argp1);
  result = (PyObject *)(arg1)->widget();
  {
    resultobj = result;
  }
  return resultobj;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Canvas_widget", _wrap_Canvas_widget, METH_VARARGS, NULL},
