...
1. On anything other than a Mac using MacPorts, or if you just want to do
   ...
   * Macintosh:
       ...
       sufficient to install the packages `cmake`, `swig`,
       `swig-python`,
       `py27-gobject3`, `gtk3`,
   ...
   * Linux:
       ...
       `python-gi-cairo`, `g++`, `cmake`, and `swig`. (Type `sudo apt
       install libgtk-3-dev`, etc.)
...
1. Create a subdirectory in which to build OOFCanvas and move to it:
...
1. Install OOFCanvas:
    ...
    If it was set to your home directory, type
