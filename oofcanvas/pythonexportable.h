...
// In addition, checking that SWIG_RUNTIME_VERSION is not already
// defined is necessary because swigruntime.h, as generated by swig,
// does not include any #ifndefs to ensure that it's included only
// once.  The copy of swigruntime.h included in OOFCanvas does contain
// #ifndef, but we have no guarantee that the program that's using
// OOFCanvas doesn't have its own unprotected copy.

#ifndef SWIG_FILE_WITH_INIT
#if !defined(SWIG_RUNTIME_VERSION)
