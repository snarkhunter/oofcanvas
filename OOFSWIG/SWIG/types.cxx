...
/***********************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/types.cxx,v 1.1 2014/06/25 18:41:36 lck Exp $
 *
 * types.cxx
 *
 ...
 */\n\
static struct {const char *n1;const char *n2; void *(*pcnv)(void *); } _swig_mapping[] = {\n";
...
void typeeq_mangle(const char *n1, const char *n2, char *cast=0) {
  DataType   t,t1;
  String     name,name2;
